...
const returnAny = (searchString) => {
    ...
    if(searchString != ''){
        for (country of countries){
            if(country.name.toUpperCase().includes(normalizedSearchString)) result.push(country)}
...
const returnStarting = (searchString) => {
    ...
    if(searchString != ''){
        for (country of countries){
            if(country.name.toUpperCase().startsWith(normalizedSearchString)) result.push(country)}
